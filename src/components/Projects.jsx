...
const Projects = () => {
    ...
    return (
        <section className='bg-gray-700 w-full relative py-10 px-4' id="projects">
            <div className='max-w-7xl mx-auto mb-16'>
                <h2 className='text-3xl text-white font-semibold border-b border-red-500 w-max pb-4 mb-8 '>My Projects
                </h2>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
                    {projectJson.map((items) => { return <Cards item={items} /> })}
                </div>
            </div>
        </section>
    )
